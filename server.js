...
const productionOutput = 'https://misc-rnnukmcdu8mee.netdna-ssl.com/tsm/admin/build';
  ...
  app.get('/admin/build/main.*.js', (req, res) => {res.sendFile(path.resolve(outputPath, 'main.2c59f7e7c57d21dba922.js'))});
  app.get('/admin/build/vendor.*.js', (req, res) => {res.sendFile(path.resolve(outputPath, 'vendor.53fcbe612079b3a8d68d.js'))});
